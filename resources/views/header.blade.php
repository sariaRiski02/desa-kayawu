<nav class="bg-white shadow-lg">
            ...
            <div class="flex space-x-4">
                ...
                <div>
                    <a href="/" class="flex items-center py-5 px-2 text-gray-700 custom-font">
                        <img src="{{ asset('storage/img/logo-tomohon.png') }}" alt="Logo" class="h-6 w-6 mr-1">
    ...
    <div class="mobile-menu hidden md:hidden custom-font">
        ...
        <a href="{{ route('potention') }}" class="block py-2 px-4 text-sm hover:bg-gray-200">Potensi</a>
        ...
        @else
        <a href="{{ route('berita') }}" class="block py-2 px-4 text-sm hover:bg-gray-200">Dashboard</a>
        @endif
    </div>
</nav>
